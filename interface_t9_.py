...
class Interface:
    ...
    def tables(self, p, _i, d):
        ...
        self.table.column('V1', width=100)
    ...
    def execute(self):
        ...
        init_params[10] = self.accuracy.get() # точность выхода на границу
        ...
        p = {'k': 12, 'x': 0, 'V1': 1, 'V2': 2,'V11': 3,'V22': 4, 'e': 5, 'h': 6, 'U1': 7,'U2': 8, 'E': 9, 'c1': 10, 'c2': 11}
